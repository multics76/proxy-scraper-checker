...
PROXY_REGEX = re.compile(
    r'(?:^|\s|"|>)(?:(?P<protocol>http|socks4|socks5):\/\/)?(?:(?P<username>[^":>\/]*):(?P<password>[^:@]*)@)?(?P<host>(?:\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])(?:\.(?:\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])){3}):(?P<port>\d|[1-9]\d{1,3}|[1-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d|6553[0-5])(?:\s|"|<|$)'
)
